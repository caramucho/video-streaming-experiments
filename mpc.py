...
def main():
    ...
    while True:  # serve video forever
        ...
        for full_combo in CHUNK_COMBO_OPTIONS:
            ...
            # bitrates are in Mbits/s, rebuffer in seconds, and
            # smoothness_diffs in Mbits/s
        ...
        # because there is an intrinsic discrepancy in passing single state and
        # batch states
